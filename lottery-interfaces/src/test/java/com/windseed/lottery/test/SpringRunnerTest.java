package com.windseed.lottery.test;
...
import com.windseed.lottery.infrastructure.dao.IActivityDao;
import com.windseed.lottery.infrastructure.po.Activity;
...
public class SpringRunnerTest {
    ...
    public void test_drawExec() {
        drawExec.doDrawExec(new DrawReq("test_user", 10001L));
    ...
    public void test_award() {
        // 执行抽奖
        DrawResult drawResult = drawExec.doDrawExec(new DrawReq("test_user", 10001L));
