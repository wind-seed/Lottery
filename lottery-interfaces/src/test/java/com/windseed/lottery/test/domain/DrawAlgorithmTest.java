...
import com.windseed.lottery.domain.strategy.model.vo.AwardRateVO;
...
import com.windseed.lottery.test.SpringRunnerTest;
...
//    @Resource(name = "singleRateRandomDrawAlgorithm")
    ...
    public void test_iDrawExec() {
        DrawResult drawResult = iDrawExec.doDrawExec(new DrawReq("test_user_002", 10001L));
