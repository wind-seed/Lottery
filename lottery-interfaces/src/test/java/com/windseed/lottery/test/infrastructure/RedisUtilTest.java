package com.windseed.lottery.test.infrastructure;
...
public class RedisUtilTest {
    ...
    public void test_set() {
        redisUtil.set("lottery_user_key","test_user");
    }
    ...
    public void test_get() {
         ...
         * 	at com.windseed.lottery.infrastructure.util.RedisUtil.get(RedisUtil.java:101)
         * 	at com.windseed.lottery.test.infrastructure.RedisUtilTest.test_get(RedisUtilTest.java:37)
